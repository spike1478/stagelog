...
class StageLogDB {
    ...
    addPerformance(performanceData) {
        ...
        const performance = {
            ...
            time_seen: performanceData.time_seen || '',
            time_slot: performanceData.time_slot || '',
            location_place_id: performanceData.location_place_id || '',
            location_address: performanceData.location_address || '',
            location_lat: performanceData.location_lat != null ? parseFloat(performanceData.location_lat) : null,
            location_lng: performanceData.location_lng != null ? parseFloat(performanceData.location_lng) : null,
    ...
    updatePerformance(id, performanceData) {
        ...
        if (index !== -1) {
            performances[index] = {
                ...performances[index],
                ...performanceData,
                time_seen: performanceData.time_seen !== undefined ? performanceData.time_seen : (performances[index].time_seen || ''),
                time_slot: performanceData.time_slot !== undefined ? performanceData.time_slot : (performances[index].time_slot || ''),
                location_place_id: performanceData.location_place_id !== undefined ? performanceData.location_place_id : (performances[index].location_place_id || ''),
                location_address: performanceData.location_address !== undefined ? performanceData.location_address : (performances[index].location_address || ''),
                location_lat: performanceData.location_lat !== undefined ? performanceData.location_lat : (performances[index].location_lat ?? null),
                location_lng: performanceData.location_lng !== undefined ? performanceData.location_lng : (performances[index].location_lng ?? null),
